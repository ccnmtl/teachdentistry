...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'PrimaryTraineesType'
        db.create_table('main_primarytraineestype', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=256)),
        ))
        db.send_create_signal('main', ['PrimaryTraineesType'])

        # Deleting field 'DentalEducator.trainees_type'
        db.delete_column('main_dentaleducator', 'trainees_type')

        # Deleting field 'DentalEducator.dental_career'
        db.delete_column('main_dentaleducator', 'dental_career_id')

        # Deleting field 'DentalEducator.other_academic_career'
        db.delete_column('main_dentaleducator', 'other_academic_career')

        # Deleting field 'DentalEducator.other_dental_career'
        db.delete_column('main_dentaleducator', 'other_dental_career')

        # Adding field 'DentalEducator.primary_trainees_type'
        db.add_column('main_dentaleducator', 'primary_trainees_type',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=0, to=orm['main.PrimaryTraineesType']),
                      keep_default=False)

        # Adding field 'DentalEducator.other_trainees_type'
        db.add_column('main_dentaleducator', 'other_trainees_type',
        ...
        # Changing field 'DentalEducator.years_teaching'
        db.alter_column('main_dentaleducator', 'years_teaching', self.gf('django.db.models.fields.CharField')(max_length=256, null=True))

    def backwards(self, orm):
        # Deleting model 'PrimaryTraineesType'
        db.delete_table('main_primarytraineestype')


        # User chose to not deal with backwards NULL issues for 'DentalEducator.trainees_type'
        raise RuntimeError("Cannot reverse this migration. 'DentalEducator.trainees_type' and its values cannot be restored.")
        # Adding field 'DentalEducator.dental_career'
        db.add_column('main_dentaleducator', 'dental_career',
                      self.gf('django.db.models.fields.related.ForeignKey')(related_name='dentaleducator_dental_career', null=True, to=orm['main.CareerType'], blank=True),
                      keep_default=False)

        # Adding field 'DentalEducator.other_academic_career'
        db.add_column('main_dentaleducator', 'other_academic_career',
                      self.gf('django.db.models.fields.CharField')(max_length=256, null=True, blank=True),
                      keep_default=False)

        # Adding field 'DentalEducator.other_dental_career'
        db.add_column('main_dentaleducator', 'other_dental_career',
                      self.gf('django.db.models.fields.CharField')(max_length=256, null=True, blank=True),
                      keep_default=False)

        # Deleting field 'DentalEducator.primary_trainees_type'
        db.delete_column('main_dentaleducator', 'primary_trainees_type_id')

        # Deleting field 'DentalEducator.other_trainees_type'
        db.delete_column('main_dentaleducator', 'other_trainees_type')
        ...
        # Changing field 'DentalEducator.years_teaching'
        db.alter_column('main_dentaleducator', 'years_teaching', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=4, decimal_places=2))
