...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'DentalEducator.video_poster'
        db.add_column('main_dentaleducator', 'video_poster',
                      self.gf('django.db.models.fields.files.FileField')(max_length=100, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'DentalEducator.video_poster'
        db.delete_column('main_dentaleducator', 'video_poster')
