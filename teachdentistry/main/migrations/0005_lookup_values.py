...
class Migration(DataMigration):
    ...
    def forwards(self, orm):
        CareerType(name='Always in dental academics').save()
        ClinicalField(name='General dentistry').save()
        Degree(name='None').save()
        Motivation(name='Family life balance').save()
        TeachingResponsibility(name='None').save()
        TimeCommitment(duration='None').save()
