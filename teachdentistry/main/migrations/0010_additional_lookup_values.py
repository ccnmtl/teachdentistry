...
class Migration(DataMigration):
    ...
    def forwards(self, orm):
        PrimaryTraineesType(name='Predoctoral dental students').save()
        PrimaryTraineesType(name='Postgraduate (Residents/Fellows)').save()
        PrimaryTraineesType(name='Dental hygienists').save()
        PrimaryTraineesType(name='Other health care professionals (medical, nursing, nutrition, etc.)').save()
