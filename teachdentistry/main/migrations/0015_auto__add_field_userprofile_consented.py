...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'UserProfile.consented'
        db.add_column(u'main_userprofile', 'consented',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'UserProfile.consented'
        db.delete_column(u'main_userprofile', 'consented')
