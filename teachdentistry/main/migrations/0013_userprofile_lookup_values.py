...
from teachdentistry.main.models import WorkDescription

class Migration(DataMigration):

    def forwards(self, orm):
        WorkDescription(description='Clinical practice, Full time private practice').save()
        WorkDescription(description='Clinical practice, Part time private practice').save()
        WorkDescription(description='Clinical practice, Full time clinical safety net practice').save()
        WorkDescription(description='Clinical practice, Part time clinical safety net practice').save()
        WorkDescription(description='Non-clinical practice: Full time non-clinical work in academica (includes teaching and research, advocacy, and the public sector)').save()
        WorkDescription(description='Non-clinical practice: Part time non-clinical work in academia (includes teaching and research, advocacy and the public health sector)').save()
        WorkDescription(description='Non-clinical practice: Full time non-clinical work in the corporate sector').save()
        WorkDescription(description='Non-clinical practice: part time non-clinical work in the corporate sector').save()
