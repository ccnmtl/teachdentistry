...
class Command(BaseCommand):
    ...
    DEPRECATED_SECTIONS = [
        'CE', 'CE Credit', 'CE Credit Confirmation'
    ]
    ...
    VIDEOS = {
        ...
        'teach_dentistry_summer2013_mcmanus_intro.mp4': 'R5EBuLxJz7Y',
        'teach_dentistry_summer2013_chinn.mp4': 'jBnbizy26_0',
        'teach_dentistry_summer2013_boyle.mp4': 'DGIYcnh8MIY',
        'teach_dentistry_summer2013_mitchell.mp4': 'UgV-c8NAn8A',
        'teach_dentistry_summer2013_mcmanus_late_career.mp4': 'qHBNyYWo0mo'
    }
